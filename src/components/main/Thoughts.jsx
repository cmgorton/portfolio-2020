...
const Thoughts = () => {
    ...
    <a target="_blank" rel="noopener noreferrer" href="https://dev.to/coffeecraftcode">The Blog &rarr;</a>
        </div>
        <img src={Girl} alt="Woman sitting at computer desk with lots of sticky notes behind her."/>
    </section>
    )
}
