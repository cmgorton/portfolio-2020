...
const HeartAni = () => {
  ...
  return (
    <div
      className="blend"
      onClick={() => heartAnimation.paused(!heartAnimation.paused())}
    >
      <svg
        className="heart"
        viewBox="0 0 24 24"
      ...
      >
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M12.0227 5.64824C11.9859 5.60894 11.9482 5.57009 11.9098 5.53171C9.95722 3.57909 6.7914 3.57909 4.83877 5.53171C2.88615 7.48433 2.88615 10.6502 4.83877 12.6028C4.9581 12.7221 5.08195 12.8341 5.20978 12.9389L5.19233 12.9563L11.2229 19.8766C11.6192 20.3314 12.3251 20.3343 12.7252 19.8828L19.0132 12.7864C19.0789 12.7272 19.1434 12.666 19.2067 12.6028C21.1593 10.6502 21.1593 7.48433 19.2067 5.53171C17.254 3.57909 14.0882 3.57909 12.1356 5.53171C12.0972 5.57009 12.0596 5.60894 12.0227 5.64824Z"
          fill="#b477aa"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M16.1116 10.655C16.4812 10.2446 17.1135 10.2114 17.5239 10.581V10.581C17.9343 10.9505 17.9675 11.5828 17.5979 11.9933L15.1482 14.7139L14.2523 15.709C13.8827 16.1194 13.2504 16.1526 12.84 15.783V15.783C12.4296 15.4135 12.3964 14.7812 12.766 14.3707L14.6054 12.3279L16.1116 10.655Z"
          fill="#48DBFB"
          fillOpacity="0.3"
        />
        <path
